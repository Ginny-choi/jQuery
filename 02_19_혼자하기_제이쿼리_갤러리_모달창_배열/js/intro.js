...
;(function($){ //$가 매개변수를 받는다 . $가 제이쿼리를 수행한다.
    ...
    var intro = {
        ...
        galleryFn:   function(){
           ...
           var arr = [ 'url(./img/blog-post-img5.jpg)' , 'url(./img/blog-post-img7.jpg)', 
                       'url(./img/blog-post-img4.jpg)', 'url(./img/blog-post-img6.jpg)'        
                      ];
                      
           var n = 0;
           var len = arr.length-1;
           console.log('이미지 배열 갯수 :' ,len);

           //갤러리 버튼을 배열처리 해준다. 해당 인덱스에서 누른 이미지를 모달창 콘텐츠 영역에서 출력한다. 
            ...
            //콘텐츠 영역 출력 함수 생성 
            function contentFn(){
                $content.css({'background-image':arr[n]}).stop().fadeOut(0).fadeIn(600);
